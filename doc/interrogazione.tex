...
Tutte le richieste fatte ai datamart vengono, di conseguenza, effettuate attraverso interrogazioni ad un DBMS Mysql.
...
A questo proposito solo una delle interrogazioni presenti in questo documeto utilizzano tale dimensione, a titolo d'esempio.
