...
\section{Differenza negli utilizzi al variare delle temperature a dipendere della presenza di scioperi}
\begin{figure}[H]                                                                                                                                                            
\centering                                                                                                                                                                   
...
\end{figure}
\iffalse
SELECT t1.total_with_strike, t2.total_without_strike, t1.temperature_level
FROM (
