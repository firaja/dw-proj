...
attori esterni non allo scopo di utilizzare il veicolo per spostarsi, pertanto
non rilevanti allo scopo del progetto. Quanto ottenuto da ogni coppia di veicoli
è via via inserito in una query di INSERT che provvede ad inserire i risultati
